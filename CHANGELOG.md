...
### Added
- Neue Mitarbeit-Tagesbewertung: bei markiertem Tisch (Sitzplan) oder ausgewähltem Schüler (Dokutabelle) setzt `+` (positive Mitarbeit), `0` (okay) oder `-` (verbesserungswürdig) eine Bewertung für den heutigen Tag, sichtbar in der Dokumentationstabelle. Erneutes Drücken der bereits gesetzten Bewertung löscht sie wieder; pro Tag ist immer nur eine der drei Bewertungen aktiv.
