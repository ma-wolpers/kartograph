...
class DetailsLayoutMixin:
    ...
    def _build_details_container_widgets(self) -> None:
        ...
        self.name_entry.bind("<FocusOut>", lambda _event: self._flush_pending_name_save())
        ...
        self.last_name_entry.bind("<FocusOut>", lambda _event: self._flush_pending_name_save())
        ...
        self.nickname_entry.bind("<FocusOut>", lambda _event: self._flush_pending_name_save())
