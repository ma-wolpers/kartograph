"""Tests für den PNG-ZIP-Export (ein transparentes Sitzkärtchen je Schüler).

Schrittweise aufgebaut: zunächst die Pillow-unabhängige Dateinamens-
Auflösung (Sanitizing + Dedup), danach Rendering und ZIP-Orchestrierung
(werden in einem späteren Umsetzungsschritt ergänzt).
"""
